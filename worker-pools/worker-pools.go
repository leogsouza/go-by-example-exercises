// In this example we'll look at how to implement a worker poll using
...
// corresponding results on results. We'll sleep a second per job
...
func main() {
	...
	// This starts up 3 workers, initially blocked beause there
	// are no jobs yet
	for w := 1; w <= 3; w++ {
		go worker(w, jobs, results)
	}

	// Here we sent 5 jobos and then close that channel to indicate
