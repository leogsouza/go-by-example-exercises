...
// utilization and maintaining quality of service. Go elegantly supports rate
// limiting with goroutines, channels and tickers.
package main
...
func main() {
	...
	// Every 200 milliseconds we'll try to add a new value to burstyLimiter, up to
	// its limit of 3.
	go func() {
